...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public TokenStore tokenStore() {
        if (jwtEnabled) {
            CustomJwtTokenStore jwtTokenStore = new CustomJwtTokenStore((JwtAccessTokenConverter) accessTokenConverter());
            jwtTokenStore.setAccessTokenRepository(accessTokenRepository);
